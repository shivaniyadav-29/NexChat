    ...
    <div className="min-h-screen bg-[#0D0D0D] flex items-center justify-center">
      <div className="bg-[#1C2541] p-8 rounded-2xl w-full max-w-md border border-[#FFA630]/20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#E5E4E2]/70 mt-2">Create your account</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-[#E5E4E2] text-sm mb-1 block">Username</label>
            <input
              type="text"
              name="username"
        ...
        <p className="text-[#E5E4E2]/70 text-center mt-6">
          ...
          <Link to="/login" className="text-[#FFA630] hover:underline">
            Login
          </Link>
        </p>
      </div>
